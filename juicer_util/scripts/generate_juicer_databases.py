...
class RunMultipleFiles():
    ...
    def __init__(self, cfe_path, juicer_path, output_filename):
        ...
        for name in self.files:
            ...
            oname = self.outDir + "/" + self.output + ".sqlite"
...
def main(argv):
    ...
    RunMultipleFiles(arg_cfe_path, arg_juicer_path, arg_output_filename)
